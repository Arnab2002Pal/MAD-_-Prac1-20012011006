fun main() {
    val car1 = Car("Lambo, 2018", "Arnab", 115, 100000.0, 98950.0)
    car1.getCarFullDetails()
    val car2 = Car("BMW, 2019", "Trisha", 120, 400000.0, 399800.0)
    car2.getCarFullDetails()
    val Cars = ArrayList<Car> (2)
    val car3 = Car("Audi, 2017","Debayudh",50,1080000.0,1079000.0)
    val car4 = Car("Maruti, 2020","Karan",20,4000000.0,3998000.0)
    Cars.add(car3)
    Cars.add(car4)
    for (i in Cars){
        println("-------------------")
